...
class WorkerRunner extends _events.EventEmitter {
  ...
  async _runBeforeHooks(test, testInfo) {
    ...
    (_completeStep = completeStep) === null || _completeStep === void 0 ? void 0 : _completeStep(testInfo.error);
  }
  ...
  async _runTestWithBeforeHooks(test, testInfo) {
    ...
    if (testInfo.status === 'failed' || testInfo.status === 'skipped') return;
  ...
  async _runAfterHooks(test, testInfo) {
    ...
    (_completeStep2 = completeStep) === null || _completeStep2 === void 0 ? void 0 : _completeStep2(teardownError);
  }
